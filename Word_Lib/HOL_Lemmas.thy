...
lemma nat_le_power_trans:
  ...
  by (metis le_imp_less_or_eq less_imp_le nat_less_power_trans power_sub 
            zero_less_numeral less_mult_imp_div_less not_le_imp_less semiring_normalization_rules(7))
