...
primrec get_axiom:: "axiom \<Rightarrow> ('sf,'sc,'sz) formula"
where 
  [code]:"get_axiom AloopIter = loop_iterate_axiom"
| [code]:"get_axiom AI = Iaxiom"
| [code]:"get_axiom Atest = test_axiom"
| [code]:"get_axiom Abox = box_axiom"
| [code]:"get_axiom Achoice = choice_axiom"
| [code]:"get_axiom AK = Kaxiom"
| [code]:"get_axiom AV = Vaxiom"
| [code]:"get_axiom Aassign = assign_axiom"
| [code]:"get_axiom Adassign = diff_assign_axiom" 
| [code]:"get_axiom AdConst = diff_const_axiom"
| [code]:"get_axiom AdPlus = diff_plus_axiom"
| [code]:"get_axiom AdMult = diff_times_axiom"
| [code]:"get_axiom ADW = DWaxiom"
| [code]:"get_axiom ADE = DEaxiom"
| [code]:"get_axiom ADC = DCaxiom"
| [code]:"get_axiom ADS = DSaxiom"
| [code]:"get_axiom ADIGeq = DIGeqaxiom"
| [code]:"get_axiom ADIGr = DIGraxiom"
| [code]:"get_axiom ADG = DGaxiom"
...
lemmas proof_ok_simps = Proof_ok_simps
...
next
  ...
  assume "i < length SG"
  assume "j < length (snd (SG ! i))"
  assume chg:"(\<forall>\<Gamma> q. (nth SG i) \<noteq> (\<Gamma>, [q]))"
  assume sound:"sound (SG, C)"
  obtain \<Gamma> and \<Delta> where SG_dec:"(\<Gamma>,\<Delta>) = (SG ! i)"
    by (metis seq2fml.cases)
...
next
  ...
  assume "i < length SG"
  assume "j < length (snd (SG ! i))"
  assume chg:"(\<forall>q. (nth SG i) \<noteq> ([], [q]))"
  assume sound:"sound (SG, C)"
  obtain \<Gamma> and \<Delta> where SG_dec:"(\<Gamma>,\<Delta>) = (SG ! i)"
    by (metis seq2fml.cases)
