...
primrec ode_to_string::"ODE \<Rightarrow> char list"
where  
...
fun fml_to_string ::"formula \<Rightarrow> char list"
and hp_to_string ::"hp \<Rightarrow> char list"
where 
